\section{Background}
As mentioned in Chapter~\ref{chapter:intro}, JavaScript has several shortcommings. Two of the tools that will be used in this project is Haste\cite{haste-lang} and JSFlow\cite{jsflow,jsflow-csf12,jsflow-sac14}.
...
\begin{figure}[h]
  \begin{lstlisting}
    ...
    var t = l + h;   // Variable t must be a high variable due to
                     // h being high
  \end{lstlisting}
