...
\begin{center}
  ...
  \end{lstlisting}
\end{center}
would give information about whether or not the variable \textbf{c} is a printable character (the ASCII values of printable characters start at 32\cite{ascii}).
